...
- `ponytail` obligatoria en todo momento al refactorizar o escribir código nuevo, asegurando minimalismo y YAGNI. Evita código largo o complejo si una solución simple funciona.
- `despliegue-azure-proyecto-nuevo` siempre que se solicite despliegue. Debe investigar en internet ante tecnologías desconocidas, buscar en repositorios si ya existe un método, y documentar claramente el proceso.
