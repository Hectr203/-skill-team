---
name: notificacion-finalizacion
description: Avisar al humano cuando el agente haya terminado una ejecucion relevante o este por entregar la respuesta final, usando una notificacion visual y audible sin depender de servicios externos.
---
...
```bash
scripts/notificar_tarea.py
```

HTML reutilizable:

```bash
scripts/notificacion_tarea.html
```
